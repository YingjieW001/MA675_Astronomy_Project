...
![Equation:](k-s eq1.png){#id .class width=20% height=10%}
B(t): Brownian Bridge
![Equation:](k-s eq2.png){#id .class width=20% height=10%}
...
## J-S Divergence
![Equation:](j-s eq1.png){#id .class width=20% height=10%}

![Where:](j-s eq2.png){#id .class width=20% height=10%}

![Discrete: also could be written as::](j-s eq3.png){#id .class width=20% height=10%}
...
return JS_divergence(PDF1.values,PDF2.values)print(JS_div(data1,data2,num_bins=20))
